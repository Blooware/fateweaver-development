...
function signIn(email, password, onSuccess, onFailure, onTempPassword) {
    ...
    cognitoUser.authenticateUser(authenticationDetails, {
        ...
        newPasswordRequired: function (userAttributes, requiredAttributes) {
            ...
            onTempPassword(userAttributes, requiredAttributes, this);
        }
    });
}


function replaceTempPassword(newPassword, attributesData, object) {

    // Get these details and call 
    // newPassword: password that user has given
    // attributesData: object with key as attribute name and value that the user has given.
    cognitoUser.completeNewPasswordChallenge(newPassword, attributesData, object)
}
