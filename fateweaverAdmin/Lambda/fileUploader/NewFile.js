...
exports.handler = (event, context, callback) => {
    ...
    async function createStudent(Group_id, StudentInfo, file){
        ...
        connection.query("select * from fateweaver.students where name = ? and info = ? and age = ? and tutor_group_id = ? ", [StudentInfo.Name, StudentInfo.Info, StudentInfo.Age, Group_id], function (error, results, fields) {
            if (results.length > 0){
                //append the Not added
