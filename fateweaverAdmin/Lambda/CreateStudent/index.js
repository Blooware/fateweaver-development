...
exports.handler = (event, context, callback) => {
    ...
    */
    ...
    function createStudent(Group_id, StudentInfo, file) {
        ...
        connection.query("select * from fateweaver.students where given_name = ? and postcode = ? and upn = ? and school_id = ?  ", [event.form.givenName, event.form.postcode, event.form.upn, school_id], function (error, results, fields) {
            if (results.length > 0) {
                context.succeed({
                    status : false,
