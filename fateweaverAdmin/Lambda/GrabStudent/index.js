...
exports.handler = (event, context, callback) => {
    ...
    connection.query("SET SESSION sql_mode=(SELECT REPLACE(@@sql_mode,'ONLY_FULL_GROUP_BY',''));", [event.account.sub], function (err, results, fields) {
        connection.query("select *, fateweaver.schools.name as schoolName, DATE_FORMAT(fateweaver.students.added, '%d/%m/%Y') as added, if (fateweaver.students.year is not null , if((DATE_FORMAT(now(), '%m')) < 9, DATE_FORMAT(now(), '%y') - DATE_FORMAT(year_added, '%y') + fateweaver.students.year, DATE_FORMAT(now(), '%y') - DATE_FORMAT(year_added, '%y') + fateweaver.students.year + 1),   ( if ((if(month(dob) >=9,1,if(month(dob) = 3, 2, 3))) = 1, ((if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now()))) - year(dob)) - 6, (if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now())) - year(dob)) - 5))) as yearGroup, DATE_FORMAT(fateweaver.students.dob, '%Y-%m-%d') as dateOfBirth, fateweaver.tutor_groups.name as tutorGroup from fateweaver.students left join fateweaver.tutor_groups on fateweaver.tutor_groups.id=fateweaver.students.tutor_group_id left join fateweaver.schools on fateweaver.schools.id=fateweaver.students.school_id where fateweaver.students.id = ? and fateweaver.students.school_id = (select school_id from fateweaver.admins where cognito_id = ? limit 1)", [event.form.student_id, event.account.sub], function (err, results, fields) {
            if (err) {
...
function getNEETScore(event, callback) {
    connection.query("select fateweaver.students.id, given_name, family_name, school_id, if((( if ((if(month(dob) >=9,1,if(month(dob) = 3, 2, 3))) = 1, ((if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now()))) - year(dob)) - 6, (if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now())) - year(dob)) - 5)) = 13), (7 - month(NOW())), if(( if ((if(month(dob) >=9,1,if(month(dob) = 3, 2, 3))) = 1, ((if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now()))) - year(dob)) - 6, (if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now())) - year(dob)) - 5)) > 13, 0 ,(((14 - ( if ((if(month(dob) >=9,1,if(month(dob) = 3, 2, 3))) = 1, ((if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now()))) - year(dob)) - 6, (if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now())) - year(dob)) - 5))) * 12) - 12) + (7 - month(NOW())))) as monthsLeftSmart, if(((14 * 12) - (year * 12)) = 12, (7 - month(NOW())), ((14 * 12) - (year * 12))) as monthsLeft,( if ((if(month(dob) >=9,1,if(month(dob) = 3, 2, 3))) = 1, ((if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now()))) - year(dob)) - 6, (if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now())) - year(dob)) - 5)) as smartYear, if((( if ((if(month(dob) >=9,1,if(month(dob) = 3, 2, 3))) = 1, ((if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now()))) - year(dob)) - 6, (if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now())) - year(dob)) - 5)) = 13), (7 - month(NOW())), if(( if ((if(month(dob) >=9,1,if(month(dob) = 3, 2, 3))) = 1, ((if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now()))) - year(dob)) - 6, (if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now())) - year(dob)) - 5)) > 13, 0 ,(((14 - ( if ((if(month(dob) >=9,1,if(month(dob) = 3, 2, 3))) = 1, ((if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now()))) - year(dob)) - 6, (if(if(month(NOW()) >=9,1,if(month(NOW()) = 3, 2, 3)) = 1, year(DATE_ADD(now(), INTERVAL 1 YEAR)),year(now())) - year(dob)) - 5))) * 12) - 12) + (7 - month(NOW())))) as monthsLeftSmart, if(((14 * 12) - (year * 12)) = 12, (7 - month(NOW())), ((14 * 12) - (year * 12))) as monthsLeft, if(((14 * 12) - (year * 12)) = 12, (7 - month(NOW())), ((14 * 12) - (year * 12))) as monthsLeft, if (fateweaver.students.year is not null , if((DATE_FORMAT(now(), '%m')) < 9, DATE_FORMAT(now(), '%y') - DATE_FORMAT(year_added, '%y') + fateweaver.students.year, DATE_FORMAT(now(), '%y') - DATE_FORMAT(year_added, '%y') + fateweaver.students.year + 1), (select if (DATE_FORMAT(dob, '%m') < 9, (DATE_FORMAT(NOW(), '%Y') - DATE_FORMAT(dob, '%Y') - (DATE_FORMAT(NOW(), '00-%m-%d') < DATE_FORMAT(dob, '00-%m-%d')) - 4 ) , (DATE_FORMAT(NOW(), '%Y') - DATE_FORMAT(dob, '%Y') - (DATE_FORMAT(NOW(), '00-%m-%d') < DATE_FORMAT(dob, '00-%m-%d')) - 5 ) ))) as yearGroup, (select count(*) from fateweaver.student_interests where student_id = fateweaver.students.id) as loggedInterests, (select TIMESTAMPDIFF(MONTH, NOW(), fateweaver.destination_sessions.added) from fateweaver.destination_sessions where student_id = fateweaver.students.id order by id desc limit 1) as timeSinceLastSession, (select if((select count(*) from fateweaver.destination_sessions where student_id = fateweaver.students.id) > 0, if(length((select confirmed_place from fateweaver.destination_sessions where student_id = fateweaver.students.id order by id desc limit 1)) > 0, 1, 0) , 0)) as confirmedPlace, (select count(*) from fateweaver.mentor_assigned where student_id = fateweaver.students.id) as assignedMentors from fateweaver.students where school_id =  (select school_id from fateweaver.admins where cognito_id = ?) and fateweaver.students.id = ?", [event.account.sub, event.form.student_id], function (err, results, fields) {
        if (err) {
            console.log("Error getting tutor groups:", err);
            context.succeed({
                statusCode: 200,
